            ...
            <div className="flex flex-col sm:flex-row lg:flex-row gap-10 my-5">
                <div className="h-[100vh] flex-1">
                    <div className="h-50 content-center justify-items-center">
                        <Avatar className="-z-1 size-32 cursor-pointer ring-1 hover:ring-2 ring-purple-600 hover:ring-purple-4">
                            <AvatarImage
                                src=""
                                alt=""
                            />
                    ...
                    <div className="flex flex-col gap-2 px-10 mt-2">
                        ...
                        <Button className="rounded-2xl mt-4">Follow Botton</Button>
                    </div>
